odoo.define('phd_account_reports.general_ledger', function (require) {
    'use strict';
    ...
    var accountReportsWidget = AccountReport.include({
        custom_events: {
            'value_changed': function(ev) {
                 ...
                 self.report_options.account_types = ev.data.account_types;
        ...
        if (this.report_options.analytic) {
            if (!this.M2MFilters) {
                ...
                if (this.report_options.account_types) {
                    fields['account_types'] = {
                        label: _t('Type'),
                        modelName: 'account.account.type',
                        value: this.report_options.account_types.map(Number),
                    };
                }
                if (!_.isEmpty(fields)) {
                    this.M2MFilters = new M2MFilters(this, fields);
